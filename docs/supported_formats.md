...
|--------|--------|----------|-------|
| OpenAPI YAML | tested | `tests/data/openapi/**/*.yaml` (31 fixtures) | Primary fixture format exercised under `tests/data/openapi/**/*.yaml`. |
...
| Coverage fixtures | 6 | `callbacks.yaml`, `callbacks_with_operation_id.yaml`, `faux_immutability.yaml` | Focused fixtures for callbacks, non-200 responses, and other regression edges. |
